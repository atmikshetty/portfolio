...
const Aboutme = () => {
    return (
        <section id="aboutme" className="min-h-screen flex flex-col items-center justify-center p-8 md:flex-row md:space-x-12">
            ...
            <div className="max-w-md text-center md:text-left">
                <h2 className="text-3xl sm:text-4xl font-bold mb-4">A little bit about myself...</h2>
